...
def getDataFromFiles(theFileSet, startTime, endTime, nChannelsTotal, nChannelsToRead, secondsPerFile, ignoreChannels):
    ...
    data = np.zeros((nChannelsToRead,int(samplesPerSecond*(endTime-startTime).total_seconds())))
    currentIdx = 0
